  ...
  return (
    <header className="bg-white border-b border-slate-100 text-slate-800 h-16 flex items-center justify-end px-6 sticky top-0 z-40 dark:bg-slate-900 dark:border-slate-800 dark:text-slate-100" id="app-header">
      <div className="flex items-center gap-3">
        {/* User Identity */}
        <div className="h-8 w-8 rounded-full bg-slate-100 flex items-center justify-center text-xs font-bold text-slate-700 border border-slate-200 dark:bg-slate-850 dark:text-slate-200 dark:border-slate-700">
